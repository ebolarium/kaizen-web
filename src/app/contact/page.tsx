...
export default function Contact() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // You can implement actual form submission logic
          ...
          <div className="grid lg:grid-cols-2 gap-12">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="erasmus">Erasmus+ Projects</option>
            ...
            <div>
              ...
              <div className="mb-6 p-6 bg-blue-50 rounded-xl">
                <h3 className="text-lg font-semibold text-gray-800 mb-2">KAIZEN Intercultural Communication and Educational Research Association</h3>
                <p className="text-gray-600">
                  You can contact us using the form for project ideas, partnerships or questions.
                </p>
              </div>
              ...
              <div className="space-y-8">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">ngokaizen@gmail.com</p>
                  </div>
                </div>
              ...
              <div className="mt-8">
                ...
                <div className="flex space-x-4">
                  <a 
                    ...
                    className="w-12 h-12 rounded-lg flex items-center justify-center hover:opacity-80 transition-opacity duration-200"
                  >
